...
<form action="<%=OFDView.FOOD_LIST_CTL%>" method="post">
    	...
    	<div class="container-wrap">
    		...
    		<%
    			...
    			<div class="col-lg-4 d-flex ftco-animate" style="margin-left: 10px; margin-top: 10px">
    				<div class="services-wrap d-flex">
    					...
    					<div class="text p-4">
    						...
    						<p>MRP:&nbsp;<%=bean.getFoodPrice()%>&nbsp;&nbsp;Discount:&nbsp;<%=bean.getDisscount()%>%</p>
    						<p class="price">Price After Discount: <span>&nbsp;<%=bean.getFinalPrice()%></span></p>
